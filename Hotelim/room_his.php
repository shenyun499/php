<?php  
    ...
    mysql_query("set names 'utf-8'");
   	 /*2、写sql语句：增删改查*/  
    $sql = "select room_id,cust_name,sex,plan_enter_date,order_log.order_id,enter_date,leave_date,order_money 
    			from order_log,book_room,customer where order_money is not null and 
