<?php  
    ...
    $plan_leave_date = $_POST["plan_leave_date"];//预计离开时间
    if($room_id == "" || $order_id == "" || $cust_id == "" || $ptype_id == "" || $cust_name == "" || $nex == "" || $phone == "" || $plan_leave_date == "")  
    {  
        ...
        {  
	        ...
	        $sql04 = "insert into order_log(order_id,cust_id,enter_date,plan_leave_date) values('$order_id','$cust_id',now(),'$plan_leave_date')";
        ...
        {  
            echo "<script>alert('房间号不存在或者已有人入住，请重新选择房间！');history.go(-1);</script>";  
        }  
    }
?>