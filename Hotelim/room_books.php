<?php  
    ...
    mysql_query("set names 'utf-8'");
   	 /*2、写sql语句：增删改查*/  
    $sql = "select room_id,cust_name,sex,plan_enter_date,order_log.order_id from order_log,book_room,customer where 
    			enter_date is null and plan_enter_date is not null and 
